...
const validate = combineValidators({
  ...
  description: composeValidators(
    ...
    hasLengthGreaterThan(4)({
      message: "Your description needs to be at least 5 characters."
    })
  )(),
...
class EventForm extends Component {
  ...
  handleVanueSelect = selectedVenue => {
  ...
  render() {
    ...
    return (
      <Grid>
        <Script
          url="https://maps.googleapis.com/maps/api/js?key=AIzaSyAfg7MbJnaMrsf6pOZFb7ZsCUD38eGpu6U&libraries=places"
